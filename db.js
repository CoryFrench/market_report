  ...
  getZipSeriesByZip: async (zip, months = 24) => {
    const queryText = `
      ...
      SELECT 
        ...
        j.active_listing_count_mm AS active_listing_count_mm,
        j.active_listing_count_yy AS active_listing_count_yy,
        j.new_listing_count AS new_listing_count,
        j.new_listing_count_mm AS new_listing_count_mm,
        j.new_listing_count_yy AS new_listing_count_yy,
        j.pending_listing_count AS pending_listing_count,
        j.pending_listing_count_mm AS pending_listing_count_mm,
        j.pending_listing_count_yy AS pending_listing_count_yy,
        j.total_listing_count AS total_listing_count,
        j.total_listing_count_mm AS total_listing_count_mm,
        j.total_listing_count_yy AS total_listing_count_yy,
        j.price_increased_count AS price_increased_count,
        j.price_increased_count_mm AS price_increased_count_mm,
        j.price_increased_count_yy AS price_increased_count_yy,
        j.price_reduced_count AS price_reduced_count,
        j.price_reduced_count_mm AS price_reduced_count_mm,
        j.price_reduced_count_yy AS price_reduced_count_yy,
        j.price_increased_share AS price_increased_share,
        j.price_increased_share_mm AS price_increased_share_mm,
        j.price_increased_share_yy AS price_increased_share_yy,
        j.price_reduced_share AS price_reduced_share,
        j.price_reduced_share_mm AS price_reduced_share_mm,
        j.price_reduced_share_yy AS price_reduced_share_yy,
        j.avg_listing_price AS avg_listing_price,
        j.med_listing_price AS median_listing_price_proxy,
        j.med_listing_price AS median_listing_price,
        j.median_days_on_market AS avg_days_on_market,
        j.median_days_on_market_mm AS avg_days_on_market_mm,
        j.median_days_on_market_yy AS avg_days_on_market_yy,
        j.median_price_per_sqft AS avg_price_per_sqft,
        j.median_price_per_sqft_mm AS avg_price_per_sqft_mm,
        j.median_price_per_sqft_yy AS avg_price_per_sqft_yy,
        j.median_square_feet AS median_square_feet,
        j.median_square_feet_mm AS median_square_feet_mm,
        j.median_square_feet_yy AS median_square_feet_yy,
